...
.fa-brands, .fab {
    ...
    <section class="section-contact bg1-pattern p-t-90">
        ...
        <div class="container">
            ...
            <form action="{{ secure_url('createContact') }}" class="wrap-form-reservation size22 m-l-r-auto" method="post">
                @csrf
                @if ($errors->any())
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                            <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="name" placeholder="Nom complet" aria-label="Nom complet" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <span class="txt9">Email</span>
                        <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
                            <input class="bo-rad-10 sizefull txt10 p-l-20" type="email" name="email" placeholder="Email" aria-label="Email" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <span class="txt9">Telephone</span>
                        <div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
                            <input class="bo-rad-10 sizefull txt10 p-l-20" type="tel" name="phone" placeholder="Telephone" aria-label="Telephone" required>
                        </div>
                    </div>
                    <div class="col-12">
                        <span class="txt9">Message</span>
                        <textarea class="bo-rad-10 size35 bo2 txt10 p-l-20 p-t-15 m-b-10 m-t-3" name="message" placeholder="Message" aria-label="Message" required></textarea>
                    </div>
                </div>
                <div class="wrap-btn-booking flex-c-m m-t-13">
                    <button type="submit" class="btn3 flex-c-m size36 txt11 trans-0-4">envoyer</button>
                </div>
            </form>
